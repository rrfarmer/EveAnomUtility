...
function buildTheScoreGuristasDraft(mission, baseTemplate) {
  ...
  const rooms = [
    {
      ...
      role: "gate_only",
      initialState: "active",
      notes: "The first pocket is only the acceleration gate.",
    },
    {
      roomKey: "room:combat",
      label: "Pirate Pocket",
      ...
      notes: "All hostile groups are in the second room.",
    },
  ];
  const encounters = [
    {
      key: "group_1_frigates",
      label: "Group 1 - Pithi Saboteur/Despoiler",
      spawnQuery: "parity_guristas_missile_frigate",
      count: 3,
      amount: 3,
      ...
      notes: "EVE University lists 3 frigates at about 40 km.",
    },
    {
      key: "group_2_frigates",
      label: "Group 2 - Pithi Frigates",
      spawnQuery: "parity_guristas_missile_frigate",
      count: 3,
      amount: 3,
      trigger: "on_room_active",
      ...
      notes: "Blitz source says destroy Group 2.",
    },
    {
      key: "group_2_destroyer",
      label: "Group 2 - Pithior Destroyer",
      spawnQuery: "parity_guristas_missile_destroyer",
      count: 1,
      amount: 1,
      trigger: "on_room_active",
      roomKey: "room:combat",
      ...
      notes: "Objective group destroyer from EVE University Group 2.",
    },
    {
      key: "group_3_frigates",
      label: "Group 3 - Pithi Plunderer/Wrecker/Destructor",
      spawnQuery: "parity_guristas_missile_frigate",
      count: 3,
      amount: 3,
      trigger: "on_room_active",
  ...
  return {
    ...
    notes: [
      ...
      "Room 1 is modeled as a gate-only entry room; all hostile groups spawn in room:combat when the gate is used.",
